...
# Usage: ./deploy-frontend.sh [stack-name] [agent-runtime-arn] [cognito-user-pool-id] [cognito-client-id] [memory-id]
...
echo "🚀 Deploying Envision Agent Frontend with Cognito Authentication and Memory"
echo "=========================================================================="
